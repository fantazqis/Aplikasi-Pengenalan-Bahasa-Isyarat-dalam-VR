    ...
    Gesture Recognize()
    {
        ...
        foreach (var gesture in gestures)
        {
            ...
            for (int i = 0; i < fingerbones.Count; i++)
            {
                ...
                Debug.Log("fingebones distance = " + i);
                ...
                Debug.Log("fingebones sumDistance = " + i);
            ...
            if (!isDiscarded && sumDistance < currentMin)
            {
                ...
                Debug.Log("currentGesture Before = " + currentGesture);
                Debug.Log("gesture Before = " + gesture);
                currentGesture = gesture;
                Debug.Log("currentGesture After = " + currentGesture);
                Debug.Log("gesture After = " + gesture);
            }
        }
